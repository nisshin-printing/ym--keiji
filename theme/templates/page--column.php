<?php
	$url = "https://www.law-yamashita.com/wp-json/wp/v2/posts?_embed&per_page=20&order=desc&orderby=date&categories={$show_cat}";
...
<?php
	...
	if ( 20 <= $headerArray['X-WP-Total'] ) {
		echo '<p class="text-center"><a href="https://www.law-yamashita.com/?cat=', $show_cat, '" class="button large" target="_blank">もっと見る<br><span style="font-size:0.8em">※メインサイトへ移行します。</span></a></p>';
	}
?>
