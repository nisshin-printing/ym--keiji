...
?>
	...
	<head>
		...
		<script>
			...
			})(window, document, 'script', 'dataLayer', 'GTM-MM3VKH');
	...
	<body id="js-body" <?php body_class(); ?>>
		...
		<noscript>
			<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MM3VKH" height="0" width="0" style="display:none;visibility:hidden"></iframe>
		</noscript>
		...
		<header id="top">
			<div class="top-bar">
				...
				<div class="column small-10 large-9">
					<p class="top-bar--desc">刑事事件の経験豊富な弁護士なら広島最大級の</p>
